...
mod tests {
    ...
    fn test_display_state() -> DisplayState {
        DisplayState {
            ...
            visible_inputs: [
                Some(SlotView { input_id: 10, name: "System".into(), color: (74, 144, 217), volume: 80, route_muted: false, global_muted: false, level: None, streams: vec![], is_custom: false }),
                Some(SlotView { input_id: 11, name: "Game".into(), color: (231, 76, 60), volume: 60, route_muted: false, global_muted: false, level: None, streams: vec![], is_custom: false }),
                Some(SlotView { input_id: 12, name: "Music".into(), color: (46, 204, 113), volume: 100, route_muted: false, global_muted: false, level: None, streams: vec![], is_custom: false }),
                Some(SlotView { input_id: 13, name: "Chat".into(), color: (243, 156, 18), volume: 50, route_muted: false, global_muted: false, level: None, streams: vec![], is_custom: false }),
            ],
            page: 0,
            total_pages: 2,
        }
